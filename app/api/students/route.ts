...
export async function POST(req: Request) {
  ...
  try {
    ...
    const userResult = await sql`
      ...
      VALUES (${username}, ${hashedPw}, 'student')
      RETURNING id
    `;
    ...
    const student = await sql`
      INSERT INTO students (name, nis, position, photo_url, user_id)
      VALUES (${name}, ${nis}, ${position || 'Anggota'}, ${photo_url || null}, ${userId})
      RETURNING *
    `;
